...
# Copilot Prompt Template for Code Generation

## 📌 Context
Provide a clear and detailed description of the component or code you want Copilot to generate. Include any background information and the specific framework or language (e.g., Vue, Astro, JavaScript). Mention any relevant dependencies, styling methods (e.g., TailwindCSS), and expected behavior.
